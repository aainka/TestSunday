...
namespace Aquarium
{
    abstract public class Fish
    {
        ...
        public Vector dirVector
        {
            ...
            set
            {
                TransformGroup tfGroup = new TransformGroup();
                {
                    ...
                    ScaleTransform scaleTf = (angle < 90 && angle > -90) ? 
                        new ScaleTransform(1, 1) : new ScaleTransform(1, -1);
        ...
        public double Distance(Fish me)
        {
            return Point.Subtract(position, me.position).Length;
        }
    }
}
